...
class StatefulColorScheme(
    ...
    surfaceBrightState: State<Color> = mutableStateOf(Color.Unspecified, structuralEqualityPolicy()),
    surfaceDimState: State<Color> = mutableStateOf(Color.Unspecified, structuralEqualityPolicy()),
    surfaceContainerState: State<Color> = mutableStateOf(Color.Unspecified, structuralEqualityPolicy()),
    surfaceContainerHighState: State<Color> = mutableStateOf(Color.Unspecified, structuralEqualityPolicy()),
    surfaceContainerHighestState: State<Color> = mutableStateOf(Color.Unspecified, structuralEqualityPolicy()),
    surfaceContainerLowState: State<Color> = mutableStateOf(Color.Unspecified, structuralEqualityPolicy()),
    surfaceContainerLowestState: State<Color> = mutableStateOf(Color.Unspecified, structuralEqualityPolicy()),
) {
    constructor(
