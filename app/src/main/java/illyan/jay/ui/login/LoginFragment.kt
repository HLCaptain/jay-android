...
class LoginFragment : RainbowCakeFragment<LoginViewState, LoginViewModel, FragmentLoginBinding>() {
    ...
    override fun render(viewState: LoginViewState) {
        ...
        when (viewState) {
            is Initial -> {
                binding.loginStatus.text = getString(R.string.initializing)
            }
            is Loading -> {
            ...
            is LoggingIn -> {
                ...
                binding.loginStatus.text = getString(R.string.logging_in)
            }
            is LoggedIn -> {
                binding.loginStatus.text = getString(R.string.logged_in)
            ...
            is LoggedOut -> {
                binding.loginStatus.text = getString(R.string.logged_out)
            }
        }.exhaustive
    }
