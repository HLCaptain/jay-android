...
class RealtimeMapNavFragment : RainbowCakeFragment<RealtimeMapNavViewState, RealtimeMapNavViewModel, FragmentRealtimeMapNavBinding>() {
    ...
    override fun provideViewBindingInflater(): (LayoutInflater, ViewGroup?, Boolean) -> FragmentRealtimeMapNavBinding =
        FragmentRealtimeMapNavBinding::inflate
    ...
    override fun onStart() {
        ...
        (requireActivity() as MainActivity).addNavController(
            binding.realtimeMapNavHost.findNavController()
        )
    }
