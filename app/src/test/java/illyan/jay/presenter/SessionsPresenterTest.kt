...
class SessionsPresenterTest : TestBase() {
	...
	private val uiLocation = UiLocation(location.id, location.latLng, location.speed, location.sessionId, location.time, location.accuracy, location.bearing, location.bearingAccuracy, location.altitude, location.speedAccuracy, location.verticalAccuracy)
	...
	private val uiLocations = listOf(
		UiLocation(locations[0].id, locations[0].latLng, locations[0].speed, locations[0].sessionId, locations[0].time, locations[0].accuracy, locations[0].bearing, locations[0].bearingAccuracy, locations[0].altitude, locations[0].speedAccuracy, locations[0].verticalAccuracy),
		UiLocation(locations[1].id, locations[1].latLng, locations[1].speed, locations[1].sessionId, locations[1].time, locations[1].accuracy, locations[1].bearing, locations[1].bearingAccuracy, locations[1].altitude, locations[1].speedAccuracy, locations[1].verticalAccuracy),
		UiLocation(locations[2].id, locations[2].latLng, locations[2].speed, locations[2].sessionId, locations[2].time, locations[2].accuracy, locations[2].bearing, locations[2].bearingAccuracy, locations[2].altitude, locations[2].speedAccuracy, locations[2].verticalAccuracy),
		uiLocation,
	)
